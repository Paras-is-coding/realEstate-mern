...
const handleSubmit =async (e)=>{
  ...
  return (
    <main className=' p-3 max-w-4xl mx-auto'>
        <h1 className='font-bold text-3xl text-center mt-3'>Update the Listing</h1>
        ...
        <div id='right' className='flex flex-col gap-2 flex-1'>
            ...
            <button type='submit' disabled={loading || uploading}  className=' p-3 bg-slate-700 text-white uppercase rounded-lg mt-3 hover:opacity-95 disabled:opacity-80'>{loading?"Updating..." : "Update Listing"}</button>
